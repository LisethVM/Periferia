        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VentaClienteId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductosVendidos_Ventas_VentaClienteId",
                        column: x => x.VentaClienteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductosVendidos_VentaClienteId",
                table: "ProductosVendidos",
                column: "VentaClienteId");
